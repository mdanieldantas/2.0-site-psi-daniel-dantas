        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[100]">
          <div className="bg-white rounded-lg shadow-xl max-w-sm w-full mx-4 overflow-hidden">
            ...
            <div className="bg-[#25D366] p-3 flex items-center justify-between">
              ...
              <button onClick={() => setIsFormOpen(false)} className="text-white" aria-label="Fechar formulário">
                <svg
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <input
                    ...
                    className="w-full py-2 border-b border-gray-300 focus:border-[#25D366] focus:outline-none text-gray-700"
                  />
                </div>
